                ...
                {[
                    {
                        ...
                        cards: [
                            { title: "Introduction to Productivity Tools", img: "assests/Imgs/Graphic/Design Process-amico.svg", type: "video", duration: "1.5 hours", youtubeLink: "https://youtu.be/wx_wzKs2JWA?si=oGVsXz9Xm0W667As" },
                            { title: "Task & Time Management Basics", img: "assests/Imgs/Graphic/Time management-pana.svg", type: "video", duration: "2 hours", youtubeLink: "https://youtu.be/iDbdXTMnOmE?si=oZpDly-Dm2WAO9X7" },
                            { title: "Digital Note-Taking & Organization", img: "assests/Imgs/Graphic/Process-rafiki.svg", type: "article", duration: "1.5 hours", youtubeLink: "https://niftypm.com/blog/best-note-taking-apps/?utm_campaign=21617982616&utm_source=g&utm_medium=cpc&utm_content=&utm_term=&ad_id=710386916580%E2%80%A9&utm_term=&utm_campaign=&utm_source=adwords&utm_medium=ppc&hsa_acc=6503027811&hsa_cam=21617982616&hsa_grp=165974673309&hsa_ad=710386916580&hsa_src=g&hsa_tgt=dsa-3500001&hsa_kw=&hsa_mt=b&hsa_net=adwords&hsa_ver=3&gad_source=1&gad_campaignid=21617982616&gbraid=0AAAAACydPO_350A7WHj51oy_gFU6XGaV1&gclid=CjwKCAiAxc_JBhA2EiwAFVs7XOY3E_Anhcnk4IS8n_hn3LviVKXYwPpl3d49ye15dsvZlKwCDWEU5hoC3toQAvD_BwE" }
                        ]
                    },
                    {
                        title: "Module 2: Collaboration & Communication Tools",
                        cards: [
                            { title: "Google Workspace & Microsoft 365", img: "assests/Imgs/Graphic/Process-cuate.svg", type: "video", duration: "2.5 hours", youtubeLink: "https://youtu.be/-Is_KNM9eA0?si=Qlnv8Nll5Z2Z2xil" },
                            { title: "Team Communication with Slack & Microsoft Teams", img: "assests/Imgs/Graphic/Process-bro.svg", type: "video", duration: "1 hour", youtubeLink: "https://youtu.be/3dCDAxDu3oM?si=wXbaLb4LBgXvM95F" },
                            { title: "Project Management Platforms: Trello & Asana", img: "assests/Imgs/Graphic/Blog post-bro.svg", type: "video", duration: "3 hours", youtubeLink: "https://youtu.be/42s_zICA3Yg?si=QXK2tlv6niPcXQ4-" }
                        ]
                    },
                    {
                        title: "Module 3: Automation & Workflow Optimization",
                        cards: [
                            { title: "Introduction to Automation", img: "assests/Imgs/Graphic/Innovation-amico.svg", type: "video", duration: "1.5 hours", youtubeLink: "https://youtu.be/4PZYb86j4wg?si=sQ4UQZ3ro5hW1S3O" },
                            { title: "Managing Focus & Distractions", img: "assests/Imgs/Graphic/Mind map-pana.svg", type: "video", duration: "2 hours", youtubeLink: "https://youtu.be/Hu4Yvq-g7_Y?si=7REPFPMfOoeHQ4JB" },
                            { title: "Calendar & Scheduling Mastery", img: "assests/Imgs/Graphic/Time management-pana.svg", type: "article", duration: "1.5 hours", youtubeLink: "https://www.memtime.com/blog/how-to-master-calendar-time-management" }
                        ]
                    }
                ].map((module, mIndex) => (
